  ...
  return (
    <form onSubmit={onSubmitHandler} className='min-h-[80vh] flex items-center justify-center pt-36 pb-8'>
      ...
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96  border rounded-xl text-zinc-600 text-sm shadow-lg'>
          ...
          <button type='submit' className='bg-primary-blue text-white w-full py-2 rounded-md text-base'>{state === 'Sign Up' ? 'Create Account' : 'Login'}</button>
          {
            state === 'Sign Up'
            ...
            : <p>Create a new account? <span onClick={()=>setState('Sign Up')} className='text-primary-blue underline cursor-pointer'>Click here</span></p>
          }
      </div>
